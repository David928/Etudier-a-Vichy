//
//  RestaurantAnnonationView.swift
//  Etudier à Vichy
//
...
class RestaurantAnnonationView: MKAnnotationView {
    ...
    func setupCenter() -> UIView? {
        guard let anno = annotation as? RestaurantAnnotation else { return nil}
    ...
    @objc func detail() {
        guard let anno = annotation as? RestaurantAnnotation else { return }
